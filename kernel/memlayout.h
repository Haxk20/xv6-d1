...
// D1 has entry.S on:
// 0x40000000 and kernel text and data follows.

// qemu puts UART registers here in physical memory. (So does real hardware.... DUH)
#define UART0 0x02500000L
#define UART0_IRQ 18

// virtio mmio interface (Useless to us)
